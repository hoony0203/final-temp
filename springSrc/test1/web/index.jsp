...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/test/resources/css/memberLogin.css">    
                    ...
                    <div id="registForm">
                        ...
                        <table id="registTable">
                                ...
                                <tr>
 								...
 								<tr> 
                                    <td> 
                                        ...
                                        <div style="width:350px; height:158px; margin-left:15px; background-color: white; border-radius: 10px;">
                                        	<br>
                                ...
                                <tr>
                                	...
                                	<td>
                                	<label>개인 / 기업회원 선택</label>
                                	</td>
                                
                                </tr>
 								<tr> 
                                    <td><a></a> 
                                        <input type="radio" id="privateRadio" name="privateRadio" class="radioBtn"><label id="private" name="private" class="radioLabel">개인</label>
                                        <input type="radio" id="coprRadio" name="corpRadio" class="radioBtn"><label id="private" name="private" class="radioLabel">회원</label>
